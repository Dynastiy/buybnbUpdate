      ...
      <div class="container py-4">
        ...
        <div class="mt-3" v-if="amount">
          ...
          <!-- Goodnews Microfinance Bank -->
            ...
            <div>
              <router-link :to='"/buy/bnb/wallet-details"'>
                  <button @click="saveAmount(qty2)" class="btn btn-danger">Sell</button>
              </router-link>
            </div>
          </div>
          ...
          >
            ...
            <div>
              <router-link :to='"/buy/bnb/wallet-details"'>
                  <button @click="saveAmount(pty2)" class="btn btn-danger">Sell</button>
              </router-link>
            </div>
          </div>
        </div>

...
export default {
  ...
  methods: {
    ...mapActions("home", ["createDeposit", "removeSubmitted"]),
    onFileChange(e) {
    ...
    makeDeposit() {
      ...
      formData.append("amount_bnb", this.amount.bnb_amount);
      formData.append("amount_naira", this.amount.ngn_amount);
      this.createDeposit(formData);
    },
    goToOrder(){
  ...
  computed: {
    ...
    ...mapState("home", ["loading", "submitted", "deposit_details"]),
  },
};
</script>